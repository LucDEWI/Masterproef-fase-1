...
# In dit script kan een intrinsieke kalibratie gedaan worden van de camera via een dambordpatroon.
#Bij gebruik van een IntelRealsense D415 camera moet dit niet gedaan worden

#eigenschappen patroon
h=14
b=9
size=16 #aantal mm zijde van een vierkant op het schaakbord
